...
- When you reach the final question, conclude the interview politely
${
  isLastQuestion
    ? "-  When you reach the final question, conclude the interview politely don't ask a questions if it's the last one"
    : ""
}
